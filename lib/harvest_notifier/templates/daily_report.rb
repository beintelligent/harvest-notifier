...
module HarvestNotifier
  module Templates
    class DailyReport < Base
      ...
      USERS_LIST_TEXT = "Here is a list of people who didn't report the minimum working hours *(%<minimun_working_hours>shrs)* for *%<current_date>s*:"
      REPORT_NOTICE_TEXT = "_Please, report time and click Refresh to update the report._"
